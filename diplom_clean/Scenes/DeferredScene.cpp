...
void DeferredScene::Setup() {
    ...
    m_Registry.on_construct<InstancedModelComponent>().connect<&DeferredScene::AddInstancedModel>(this);
    m_Registry.on_update<TransformComponent>().connect<&DeferredScene::UpdateInstancedModel>(this);
