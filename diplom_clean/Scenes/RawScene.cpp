...
void RawScene::Setup() {
    ...
    m_CubeModel = Model("Models/Crate/Crate1.obj");
    m_Backpack = Model("Models/backpack/backpack.obj");
...
void RawScene::Render() {
    ...
    glBindFramebuffer(GL_FRAMEBUFFER, m_hdrFBO);
    {
        ...
        for (const auto& _light_pos : temporary_light_data) {
            ...
            geometry_pass_shader->setVec3("aColor", _light_pos.Color);
